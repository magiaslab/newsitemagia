                                    ...
                                    <div className="max-w-screen-md px-4 py-8 mx-auto lg:py-8">
                                        ...
                                        <form action="#" className="space-y-8" onSubmit={handleSubmit}>
                                            ...
                                            <div className="sm:col-span-2">
                                                <label htmlFor="message" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Il tuo messaggio</label>
                                                <textarea
                                                    id="message"
                                                    name="input3"
                                                    value={inputValues.input3}
                                                    onChange={handleChange}
                                                    className="relative block w-full px-3 py-2 text-gray-900 placeholder-gray-500 border rounded-md appearance-none border-linegrey focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="Scrivi un commento..."></textarea>
                                            </div>
                                            <button type="submit"
                                                onClick={handleClick}
                                                disabled={isDisabled}
                                                className="w-full px-5 py-3 text-sm font-medium text-center text-white rounded-lg disabled:opacity-50 bg-blue focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Invia il messaggio</button>
